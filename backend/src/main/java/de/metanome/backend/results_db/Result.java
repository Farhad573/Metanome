...
public class Result implements Serializable {
  ...
  /**
   * A bidirectional association should be created with the
   * {@link de.metanome.backend.results_db.Execution}. Use
   * {@link de.metanome.backend.results_db.Execution#addResult(Result)} to create proper
   * associations.
   *
